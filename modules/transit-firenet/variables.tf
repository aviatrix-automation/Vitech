...
variable "name" {
  description = "Optionally provide a custom name for VPC "
  type        = string
  default     = ""
}
variable "fw1_name" {
  description = "Optionally provide a firewall instance name "
  type        = string
...
variable "gw_name" {
  description = "Optionally provide a custom name for Gateway resources."
  type        = string
  default     = ""
}
variable "prefix" {
